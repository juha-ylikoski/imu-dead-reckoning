...
Slightly modified to fix problems with RTE short length scenarios
"""
...
def compute_relative_trajectory_error(est, gt, delta, max_delta=-1):
    ...
    Actually not defined there for some reason but ronin referes to it so I will leave it here.
